...
describe('Toast', () => {
  ...
  it('renders with correct type styles', () => {
    const { container } = render(<Toast id="test" type="success" message="Success message" />);
  ...
  it('hides progress bar when progressBar is false', () => {
    const { container } = render(<Toast id="test" message="Test message" progressBar={false} />);
  ...
  it('calls onClose when clicked and closeOnClick is true', () => {
    ...
    render(<Toast id="test" message="Test message" onClose={onClose} closeOnClick={true} />);
  ...
  it('supports RTL mode', () => {
    const { container } = render(<Toast id="test" message="Test message" rtl={true} />);
